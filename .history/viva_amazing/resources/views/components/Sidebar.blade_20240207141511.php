<div class="min-h-screen bg-gray-100">
  <div class="sidebar min-h-screen overflow-hidden border-r w-56 bg-white hover:shadow-lg p-6 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)]">
    <div class="flex h-screen flex-col justify-between pt-2 pb-6">
      <div>
        <div class="w-max p-2.5">
          <img src="{{asset('assets/logo_original.png')}}" class="w-36" alt="">
        </div>
