    ...
    <div class="flex h-screen flex-col justify-between">
      <div>
        ...
        <ul class="mt-6 space-y-2 tracking-wide">
          <li class="min-w-max">
            <a href="#" aria-label="dashboard" class="relative flex items-center space-x-4 text-slate-950 px-4 py-3 text-white">
              <img src="{{asset('assets/iconos/Home.png')}}" alt="" class="-ml-1 h-6 w-6">
