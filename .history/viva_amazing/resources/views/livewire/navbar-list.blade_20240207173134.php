<div>
        <div class="w-max p-0 m-[-5px] sm:m-0 sm:p-2.5">
          <img src="{{asset('assets/logo_original.png')}}" class="sm:w-36 w-8" alt="Logo Viva Amazing">
        </div>
        <ul class="mt-6 space-y-2 tracking-wide">
          <li class="min-w-max">
            <a href="#" aria-label="dashboard" class="relative flex items-center space-x-2 text-slate-950 py-3 text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:text-[#fc9602] duration-300">
